...
#define EXT0_STEPS_PER_MM 824 //385
...
#define USER_THERMISTORTABLE1  {\
  ...
  {531*4,109*8},{584*4,101*8},{637*4,94*8},{690*4,87*8},{743*4,79*8},{796*4,70*8},{849*4,61*8},{902*4,50*8},{955*4,34*8},\
  {1008*4,2*8}	}
...
#define UI_VERSION_STRING2 "ElectricPrint"
